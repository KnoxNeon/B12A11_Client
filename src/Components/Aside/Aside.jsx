...
const Aside = () => {
  ...
  return (
    <aside className="bg-red-700 text-white w-50 md:w-64 h-screen flex flex-col">
      {/* Logo/Header */}
      ...
      {/* Navigation Menu */}
      <nav className="flex-1 px-1 md:px-4 py-2 md:py-6">
        <ul className="space-y-2">
          <li>
            <NavLink to='/dashboard/main'
              ...
              <HiOutlineHome size={24} /> <span className="md:text-lg">DashBoard Home</span>
            </NavLink>
          </li>
          <li>
            <NavLink to='/dashboard/my-profile'
              className={({isActive}) =>
                `flex items-center space-x-4 px-4 py-3 rounded-lg transition  ${isActive? "bg-white text-red-500":"hover:bg-red-600"}  }`}>
              <HiOutlineUser size={24} /> <span className="md:text-lg">My Profile</span>
            </NavLink>
          </li>

          {
            ...
            <NavLink to='/dashboard/add-request'
              className={({isActive}) =>
                `flex items-center space-x-4 px-4 py-3 rounded-lg transition ${isActive? "bg-white text-red-500":"hover:bg-red-600"}  }`}>
              <HiOutlineHeart size={24} /> <span className="md:text-lg">Add Request</span>
            </NavLink>
          </li>
            )
          }

          {
            ...
            <NavLink to='/dashboard/all-users'
              className={({isActive}) =>
                `flex items-center space-x-4 px-4 py-3 rounded-lg transition  ${isActive? "bg-white text-red-500":"hover:bg-red-600"}  }`}>
              <HiOutlineUserGroup size={24} /> <span className="md:text-lg">All Users</span>
            </NavLink>
          </li>
            )
          }
          {
            ...
            <NavLink to='/dashboard/all-requests'
              className={({isActive}) =>
                `flex items-center space-x-4 px-4 py-3 rounded-lg transition  ${isActive? "bg-white text-red-500":"hover:bg-red-600"}  }`}>
              <BsFillDropletFill  size={24} /> <span className="md:text-lg">All Requests</span>
            </NavLink>
          </li>
            )
          }
          {
            ...
            <NavLink to='/dashboard/my-requests'
              className={({isActive}) =>
                `flex items-center space-x-4 px-4 py-3 rounded-lg transition ${isActive? "bg-white text-red-500":"hover:bg-red-600"}  }`}>
              <HiOutlineUserAdd size={24} /> <span className="md:text-lg">My Requests</span>
            </NavLink>
          </li>
            )
          }
