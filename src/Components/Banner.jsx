...
const Banner = () => {
  return (
    <div className="flex flex-col lg:flex-row mx-auto w-full lg:h-150 text-center bg-linear-to-b from-sky-900 to-gray-800">
      ...
      <div className=" px-6 py-24 md:py-32 lg:py-40">
        <h1 className="text-4xl md:text-6xl lg:text-7xl font-bold leading-tight mb-8 drop-shadow-lg">
          Save a Life Today
          <br />
          <span  className="text-red-700"><Typewriter
            options={{
              strings: ["Donate Blood!"],
              autoStart: true,
              loop: true,
            }}
          /></span>
        ...
        <p className="text-xl md:text-2xl mb-12 max-w-3xl mx-auto opacity-95">
          Your one donation can save up to three lives. Join our community of
          heroes and help those in need.
        </p>
